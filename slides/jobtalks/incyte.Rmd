...
2. Motivating idea for our SDR approach
  
3. SDR for categorical and ordinal responses

4. Tuning our method procedure

4. Application to NHANES glycohemoglobin data
...
# Survival Analysis and SDR
  ...
  - Response is time-to-event, $T>0$, with potential censoring $C$. The observed time-to-event is $Y = \min\{Y,C\}$. 
