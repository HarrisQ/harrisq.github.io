...
#let partial(out, inp) = {$(#sym.partial out)/(#sym.partial inp)$}
#let derive(out, inp) = {$(upright(d) out)/(upright(d) inp)$}
...
+ $arr(y) = arr(f)(arr(w)) circle arr(g)(arr(x)) = f_i (w_i) circle g_i (x_i)$. Prove the following identities. <q5>
  + If $arr(y) = arr(f)(arr(w)) ⊕ arr(g)(arr(w))$,
    + show that $partial((arr(w) ⊕ arr(x)), arr(w)) = I$.
    + show that $partial((arr(w) ⊕ arr(x)), arr(x)) = I$.
  + If $arr(y) = arr(f)(arr(w)) ⊖ arr(g)(arr(w))$,
    + show that $partial((arr(w) ⊖ arr(x)), arr(w)) = I$.
    + show that $partial((arr(w) ⊖ arr(x)), arr(x)) = -I$.
  + If $arr(y) = arr(f)(arr(w)) ⊗ arr(g)(arr(w))$,
    + show that $partial((arr(w) ⊗ arr(x)), arr(w)) = "diag"(arr(x))$.
    + show that $partial((arr(w) ⊗ arr(x)), arr(x)) = "diag"(arr(w))$.
  + If $arr(y) = arr(f)(arr(w)) ⊘ arr(g)(arr(w))$,
    + show that $partial((arr(w) ⊘ arr(x)), arr(w)) = "diag"(dots.c 1/x_i dots.c)$.
    + show that $partial((arr(w) ⊘ arr(x)), arr(x)) = "diag"(dots.c -(w_i)/(x^2_i) dots.c)$.
+ $arr(y) = arr(f)(arr(x)) circle arr(g)(z) = arr(x) circle arrow(1)z$. Prove the following identities once with matricies and once with a general form of the equation. <q6>
  + $partial((arr(x) ⊕ z), arr(x)) = I$
  + $partial((arr(x) ⊕ z), z) = arrow(1)$
  + $partial((arr(x) ⊗ z), arr(x)) = I z$
  + $partial((arr(x) ⊗ z), z) = arr(x)$
...
+ #link(<a19>)[$y = "max"(0, arr(w) dot arr(x) + b)$.] <q19>
  + Find $partial((arr(w) ⊗ arr(x)), arr(w))$.
...
#par(leading: 1cm)[
  ...
  [ #link(<q19>)[#sym.space #sym.space #sym.space]<a19>
    + $partial((arr(w) ⊗ arr(x)), arr(w)) = "diag"(arr(x))$
